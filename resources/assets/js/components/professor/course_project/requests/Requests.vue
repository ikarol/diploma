            ...
            <div class="table-responsive">
                <div v-if="requests.length">
                    <panel v-for="request in requests" :key="request.id" :class="setPanelsColour(request)">
                        ...
                        <div slot="request-disciplines" class="form-group">
                            <label for="request-disciplines">{{ translations.labels.disciplines }}:</label>
                            <span v-for="discipline in request.disciplines" :key="discipline.id" name="request-disciplines">{{ discipline.name }}</span>
                        </div>
...
export default {
    ...
    methods: {
        ...
        getFilteredData() {
            ...
            $.ajax({
                url: '/course_projects/professor/requests',
                type: 'GET',
                dataType: 'json',
                data: {
        ...
        openCourseProject(request) {
            return '/course_projects/' + request.course_project_id;
        },
        getGroupList() {
            var self = this;
            $.ajax({
        ...
        acceptRequest(request) {
            var self = this;
            $.ajax({
                url: '/course_projects/professor/requests/accept/' + request.student_id + '/' + request.task_id,
                type: 'PATCH',
                dataType: 'json',
                data: request
            })
        ...
        declineRequest(request) {
            var self = this;
            $.ajax({
                url: '/course_projects/professor/requests/decline/' + request.student_id + '/' + request.task_id,
                type: 'PATCH',
                dataType: 'json',
                data: request
            })
